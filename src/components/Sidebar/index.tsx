    ...
    return (
        <aside className="bg-neutral-800 rounded-lg overflow-hidden">
            ...
            <footer className="border-t border-solid border-neutral-600 mt-6 pt-6 px-8 pb-8">
                <a className="flex items-center justify-center gap-2 bg-transparent font-bold text-green-500 no-underline border border-solid border-green-500 rounded-lg h-12 px-6 hover:bg-green-500 hover:text-neutral-50 transition-colors duration-100" href="#">
